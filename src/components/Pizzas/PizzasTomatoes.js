...
import dataPizzasTomatoes from "./data-pizzas-tomatoes";
import dataIngredients from "../utils/data-ingredients";

class PizzasTomatoes extends Component {

  constructor(props) {
    super(props);
    this.state = {
      pizzas_tomatoe: dataPizzasTomatoes
    }
  }
  ...
  render() {
    return (
      <Fragment>
        <div className="row">
          {this.state.pizzas_tomatoe.map( (currentPizza, index) => (
            <div className="card" key={ currentPizza.id * index}>
              <div className="card-header bg-dark text-white">
                <img 
                  src="./assets/images/ingredients/sauce_tomate.png"
                  alt="Ingrédient représentant de la sauce tomates"
                  width="80"
                />
              ...
              <div className="card-body">
                <h5 className="card-title">
                  Base : <span className="text-danger">{ currentPizza.base }</span>
                </h5>
